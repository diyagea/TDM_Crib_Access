layui.use(['form','layer','table','laytpl'],function(){
    ...
    function addData(data){
    	...
    	if(data){//update view， init data
	    	index = layui.layer.open({
	            title : "修改数据",
	            type : 2,
	            content : "limitDeviceToolAdd.html",
	            success : function(layero, index){
	                ...
	                body.find(".costunit").val(data.COSTUNIT);  
	                body.find(".workplace").val(data.WORKPLACE);  
    ...
    form.on('switch(stateSwitch)', function(obj){
	    ...
	    $.post("/limitDeviceTool/updateState",{
